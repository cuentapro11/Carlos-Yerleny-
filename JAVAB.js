...
function initializeCountdown() {
    const targetDate = new Date('2025-12-20T16:00:00').getTime();
...
function openLocation(location) {
    ...
    const mapsUrl = `https://www.google.com/maps/dir//18.8914337,-69.6325531/@18.8901697,-69.6349259,18.5z/data=!4m8!1m5!3m4!2zMTjCsDUzJzI5LjIiTiA2OcKwMzcnNTcuMiJX!8m2!3d18.8914337!4d-69.6325531!4m1!3e0?hl=es&entry=ttu&g_ep=EgoyMDI1MTEwNC4xIKXMDSoASAFQAw%3D%3D${encodeURIComponent(address)}`;
...
function showDressCode() {
    showToast("Codigo De Vestimenta", "Vestimenta formal 👗");
}

function showTips() {
    showToast("Tips y Notas", "Queremos que puedan disfrutar al máximo con nosotros, por lo que este será un evento solo para adultos. Se recomienda llegar 15 minutos antes ⛪");
}
...
function confirmAttendance() {
    const message = "¡Hola! Quiero confirmar mi asistencia a la boda de Carlos y Yerleny el 20 de Diciembre 💒✨";
    const whatsappUrl = `https://wa.me/8295197737?text=${encodeURIComponent(message)}`;
    window.open(whatsappUrl, '_blank');
}
